...
#define IDC_ARROW SDL_SYSTEM_CURSOR_ARROW

enum { FALSE=0, TRUE=1 };
const char* const WM_QUIT="quit";
const char* const WM_CLOSE="close";
const char* const IDI_ICON1="icon1";
enum { DSSCL_PRIORITY, DSBVOLUME_MAX, DSBPLAY_LOOPING, DDBLTFALST_SRCCOLORKEY, DIRECTINPUT_VERSION, DDBLT_WAIT, DDCKEY_SRCBLT, DISCL_FOREGROUND, DISCL_NONEXCLUSIVE, DISCL_EXCLUSIVE, WS_POPUPWINDOW, WS_VISIBLE, PM_NOREMOVE, PM_REMOVE, DSBVOLUME_MIN, DDBLTFAST_SRCCOLORKEY, CS_HREDRAW, CS_VREDRAW, WM_ACTIVATE, WM_CHAR, WM_DESTROY, GUID_SysKeyboard, GUID_SysMouse, BLACK_BRUSH, CW_USEDEFAULT, IID_IDirectInput8, c_dfDIKeyboard, c_dfDIMouse };
// TODO: These have no corresponding GL value
enum {
  D3DRENDERSTATE_SHADEMODE, D3DRENDERSTATE_FOGTABLEMODE, D3DRENDERSTATE_FOGVERTEXMODE, D3DRENDERSTATE_COLORKEYENABLE, D3DRENDERSTATE_CULLMODE, D3DRENDERSTATE_RANGEFOGENABLE, D3DFVF_NORMAL, D3DFVF_TEX1, D3DFVF_XYZ, D3DLIGHT_POINT, D3DLIGHT_SPOT, D3DPRASTERCAPS_FOGRANGE, D3DPRASTERCAPS_FOGVERTEX, D3DPTFILTERCAPS_MAGFANISOTROPIC, D3DPTFILTERCAPS_MAGFLINEAR, D3DPTFILTERCAPS_MINFANISOTROPIC, D3DPTFILTERCAPS_MINFLINEAR, D3DTADDRESS_MIRROR, D3DTFG_ANISOTROPIC, D3DTFG_LINEAR, D3DTFN_ANISOTROPIC, D3DTRANSFORMSTATE_PROJECTION, D3DTRANSFORMSTATE_VIEW, D3DTRANSFORMSTATE_WORLD, D3DTSS_ADDRESS, D3DTSS_MAXANISOTROPY, D3DTSS_TEXTURETRANSFORMFLAGS, D3DTTFF_COUNT2, D3DX_CONTEXT_FULLSCREEN, D3DX_DEFAULT, D3DX_FT_DEFAULT, D3DX_FT_POINT, D3DX_SF_UNKNOWN, D3DENUMRET_OK, D3DENUMRET_CANCEL, DDPF_ZBUFFER, D3DCLEAR_TARGET, D3DCLEAR_ZBUFFER, D3DRENDERSTATE_ZWRITEENABLE };

// D3D sphere visibility / clip intersection flags (bitmask, per DirectX 7 spec)
const DWORD D3DSTATUS_CLIPINTERSECTIONLEFT   = 0x00000100;
const DWORD D3DSTATUS_CLIPINTERSECTIONRIGHT  = 0x00000200;
const DWORD D3DSTATUS_CLIPINTERSECTIONTOP    = 0x00000400;
const DWORD D3DSTATUS_CLIPINTERSECTIONBOTTOM = 0x00000800;
const DWORD D3DSTATUS_CLIPINTERSECTIONNEAR   = 0x00001000;
const DWORD D3DSTATUS_CLIPINTERSECTIONFAR    = 0x00002000;
const DWORD D3DSTATUS_CLIPINTERSECTIONALL    = 0x00003F00;
...
typedef struct DIRECTINPUTDEVICE8 {
        HRESULT Acquire();
        HRESULT GetDeviceState(size_t, DIMOUSESTATE*);
        HRESULT GetDeviceState(size_t, char*);
